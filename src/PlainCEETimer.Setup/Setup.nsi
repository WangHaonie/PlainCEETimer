...
Section -POST
  ...
  File "..\.output\PlainCEETimer.exe.config"
  File "..\.output\Newtonsoft.Json.dll"
  File "..\.output\PlainCEETimer.Natives.dll"
  File "..\.output\CommunityToolkit.Mvvm.dll"
  File "..\.output\Microsoft.Bcl.AsyncInterfaces.dll"
  File "..\.output\Microsoft.Extensions.DependencyInjection.Abstractions.dll"
  File "..\.output\Microsoft.Extensions.DependencyInjection.dll"
  File "..\.output\System.Buffers.dll"
  File "..\.output\System.ComponentModel.Annotations.dll"
