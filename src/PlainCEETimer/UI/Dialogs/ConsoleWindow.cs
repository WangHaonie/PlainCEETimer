    ...
    protected override void OnInitializing()
    {
        ...
        [
            ConsoleBox = b.TextArea(600, 200, null).With(x =>
            {
                ...
                x.PreferredColors = new(
                    new(SystemColors.WindowText, SystemColors.Window),
                    new(Colors.DarkForeConsole, Colors.DarkBackConsole)
                );
            }),
    ...
    protected override void OnShown()
    {
        ...
        else
        {
            ...
            new Action(() =>
            {
                try
                {
                    WaitForExit(ProcessHelper.RunElevated(App.Current.ExecutablePath, new Arguments()
                        .Add("/run").Add(Key)
                        .Add("/exe").Add(ExePath)
