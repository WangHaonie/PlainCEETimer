...
{
	WINDOWPLACEMENT wpWnd;
	DWORD dwStyle;
	BOOL bFull;
} WNDINFO, *LPWNDINFO;

NATIVES_EXPORT BOOL NATIVESAPI PnToggleFullScreen(HWND hWnd, LPWNDINFO lpWndInfo);

NATIVES_EXPORT BOOL NATIVESAPI PnPtInWindowClient(HWND hWnd, LONG x, LONG y);
