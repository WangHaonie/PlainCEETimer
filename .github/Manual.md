<div align="center">
    ...
    <h4>适用于 v5.0.10 | 修订日期 2026/3/1</h4>
</div>
...
| **选项名称** | **功能说明** | **注意** |
| ----- | ---- | ---- |
| **应用主题设定** | 用于更改除倒计时以外的窗口 UI 主题。可选 系统默认/浅色/深色。 | 详见 [🎯 深色模式覆盖率一览](#-深色模式覆盖率一览)。仅支持 Windows 10 1903 及以上并且关闭了高对比度主题。`系统默认`并不支持在运行时随系统主题的切换而切换，需手动重启倒计时。 |
| **窗口不透明度** | 更改主窗口的不透明度，范围 20~100，越大越不透明。 | 为什么不开放 0~19 数值区间？因为在 20 时已经快看不清了。 |
| **窗口边框颜色** | 更改主窗口的边框颜色。可选`自定义`,`跟随文字颜色`,`跟随背景颜色`,`跟随系统主题色`。 | 仅限 Windows 11 及以上的系统。 |
